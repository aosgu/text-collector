...
> 依据：`docs/_facts.md` 与代码（v1.0.2，2026-08-16）。以下为关键用户流程（12 个；流程 8 为 v0.8.0 新增；流程 9–12 为 v1.0.0 新增的待办；v1.0.1 微调流程 10 中工作台输入框的尺寸反馈；v1.0.2 修复流程 1 采集反馈 toast 的视觉渲染缺陷，流程步骤不变），每个流程给出步骤与状态迁移。
